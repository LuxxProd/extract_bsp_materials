...
```bash
python extract_css_materials.py "C:\Program Files (x86)\Steam\steamapps\common\Counter-Strike Source\cstrike\maps\cs_assault.bsp" "C:\Program Files (x86)\Steam\steamapps\common\GarrysMod\garrysmod\addons\css_cs_assault_materials"
```
...
```bash
python extract_css_materials.py "C:\Program Files (x86)\Steam\steamapps\common\Counter-Strike Source\cstrike\maps\*.bsp" "C:\Program Files (x86)\Steam\steamapps\common\GarrysMod\garrysmod\addons\css_*_materials"
```
